...
void sqlReadColumnsAsync(TableInfo *table, char *limit, char *col_names, const char *where, ReadColumnCallback callback, void* callbackData, Packet *pak, int container_id);
void sqlReadColumnsAsyncWithDebugDelay(TableInfo *table, char *limit, char *col_names, const char *where, ReadColumnCallback callback, void* callbackData, Packet *pak, int container_id, int debugDelayMS);
