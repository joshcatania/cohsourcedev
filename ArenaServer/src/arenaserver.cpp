...
//    };
	...
	MessageStoreLoadFlags flags = (MessageStoreLoadFlags)(MSLOAD_SERVERONLY | MSLOAD_NOFILES);
...
static void AddTestEvent(void)
{
	...
	theEvent->teamType = (ArenaTeamType)(rand() % ARENA_NUM_TEAM_TYPES);
	theEvent->teamStyle = (ArenaTeamStyle)(rand() % ARENA_NUM_TEAM_STYLES);
