...
std::string AccountDbMssql::mergeBinsIntoProductQuery(const std::string& sourceTable) {
...
std::string AccountDbMssql::mergeBinsIntoProductTypeQuery(const std::string& sourceTable) {
