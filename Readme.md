...
* Open **Source\3rdparty\yajl\yajl_s.sln** in Visual Studio 2010 and build all configurations
* Open **Source\Utilities\StructParser\StructParser.sln** in Visual Studio 2010 and build configuration Release
* Open **Source\AuthServer\src\AuthServer\AuthServer.sln** in Visual Studio 2010 and build configuration Release
...
2. Game client build only in release mode
