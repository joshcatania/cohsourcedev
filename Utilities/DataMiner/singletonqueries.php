	...
	<form action='singletonqueries.php' method=post>
		<table align=left width=100%>
			...
			<tr>
				...
				<td class='rowf'><input type=submit class='butnew' name='playername' value='Search'></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class='rowf'><input type=submit class='butnew' name='supergroupname' value='Search'></td>
			</tr>
		</table>
	</form>
</div>
