...
function common_localagg_averageout($element)
{
    return $element ? $element[0] / $element[1] : false;
}

function common_localagg_sumin(&$element, $input)
{
    @$element += $input;
}
function common_localagg_sumout($element)
{
    return $element;
}

function common_localagg_countin(&$element, $input)
{
    @$element++;
}
function common_localagg_countout($element)
{
    return $element;
}

function common_localagg_maxin(&$element, $input)
{
    if (!isset($element) || $element < $input) {
        $element = $input;
    }

}
function common_localagg_maxout($element)
{
    return $element;
}

function common_localagg_minin(&$element, $input)
{
    if (!isset($element) || $element > $input) {
        $element = $input;
    }
...
function common_localagg_minout($element)
{
    return $element;
}
