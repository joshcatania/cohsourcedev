...
if ($table) {
    ...
    // Form handling should match this query
    foreach (new QueryIterator("SELECT * FROM containers WHERE container=" . sql_string($container) . " AND tablename LIKE " . sql_string("$table%") . " ORDER BY tablename") as $v) {
