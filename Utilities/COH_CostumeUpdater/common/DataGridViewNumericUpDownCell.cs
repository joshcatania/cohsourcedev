...
namespace COH_CostumeUpdater.common
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        //ha added to enable/disable cell
        public bool Enabled
        {
            get
            {
                //enabledValue = paintingNumericUpDown.Enabled;
                return enabledValue;
            }
            set
            {
                enabledValue = value;
                //paintingNumericUpDown.Enabled = enabledValue;
            }
        }
           ...
           // If the cell is in editing mode, there is nothing else to paint
            if (!cellEdited )
            {
                if (PartPainted(paintParts, DataGridViewPaintParts.ContentForeground))
                {
                    ...
                    paintingNumericUpDown.ForeColor = cellStyle.ForeColor;
