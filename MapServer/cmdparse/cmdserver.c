...
// 							"Open up the newspaper." }, // Using cell phone interface for newspapers now
	...
	{ 0, "setdifficultylevel",		SCMD_DIFFICULTY_SET_LEVEL, {{CMDINT(tmp_int)}}, 0,
							"Set your level (no influence charge)" },
	{ 0, "setdifficultyteamsize",		SCMD_DIFFICULTY_SET_TEAMSIZE, {{CMDINT(tmp_int)}}, 0,
							"Set your team size (no influence charge)" },
	{ 0, "setdifficultyav",		SCMD_DIFFICULTY_SET_AV, {{CMDINT(tmp_int)}}, 0,
							"Set your AV spawning (no influence charge). 1 to make AV's always appear, 0 for always EB" },
	{ 0, "setdifficultyboss",		SCMD_DIFFICULTY_SET_BOSS, {{CMDINT(tmp_int)}}, 0,
