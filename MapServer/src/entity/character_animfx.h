...
unsigned int entity_PlayMaintainedFX(Entity *eSrc, Entity *eTarget, const char *pchName, ColorPair uiTint, float fDelay, unsigned int iAttached, float fTimeOut, int iFlags);

unsigned int character_PlayMaintainedFX(Character *pSrc, Character *pTarget, const char *pchName, ColorPair uiTint, float fDelay, unsigned int iAttached, float fTimeOut, int iFlags);
unsigned int character_PlayFXLocation(Character *pSrc, Character *pTarget, const Vec3 vecTarget, const char *pchName, ColorPair uiTint, float fDelay, unsigned int iAttached, int iFlags);
unsigned int character_PlayFX(Character *pSrc, Character *pTarget, const char *pchName, ColorPair uiTint, float fDelay, unsigned int iAttached, int iFlags);
