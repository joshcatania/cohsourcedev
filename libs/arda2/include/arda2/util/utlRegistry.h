...
public:
    ...
    void SetStringValue(LPCTSTR pStrValue)
    { 
...
{
public:
    utlRegistryKey(LPCTSTR pName = NULL, LPCTSTR defaultValue = NULL);
    ~utlRegistryKey();
    ...
    utlRegistryKey* NewKey(LPCTSTR pName = NULL, LPCTSTR pDefaultValue = NULL);
    utlRegistryKey* GetKey(LPCTSTR pKeyName);

    utlRegistryValue* NewValue();
    utlRegistryValue* GetValue(LPCTSTR pValueName);
