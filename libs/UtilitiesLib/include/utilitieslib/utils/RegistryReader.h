...
int rrReadInt64(RegReader reader, const char* valueName, S64* value, S64 defValue);
int rrReadInt(RegReader reader, const char* valueName, unsigned int* value, unsigned int defValue);
