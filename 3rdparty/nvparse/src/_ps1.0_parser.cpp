...
static const short yyprhs[] = {     0,
    ...
    49,    61,    63,    66,    70,    76,    84,    86,    89,    95,
   103,   113,   115
};

static const short yyrhs[] = {     3,
    18,    12,    14,    16,     0,    18,     3,    18,    12,    14,
    16,     0,     3,    18,    14,    16,     0,    18,     3,    18,
    14,    16,     0,     3,    18,    12,    16,     0,    18,     3,
    18,    12,    16,     0,     3,    18,    16,     0,    18,     3,
    18,    16,     0,    13,     0,    12,    13,     0,     7,     6,
    10,     5,    10,     5,    10,     5,    10,     5,    18,     0,
    15,     0,    14,    15,     0,     8,     6,    18,     0,     8,
     6,    10,     6,    18,     0,     8,     6,    10,     6,    10,
     6,    18,     0,    17,     0,    16,    17,     0,     9,     6,
    10,     6,    18,     0,     9,     6,    10,     6,    10,     6,
    18,     0,     9,     6,    10,     6,    10,     6,    10,     6,
    18,     0,     4,     0,    18,     4,     0
};
...
static const short yyrline[] = { 0,
    68,    75,    82,    89,    96,   103,   110,   117,   127,   135,
   147,   161,   169,   180,   190,   202,   219,   227,   238,   251,
   265,   283,   287
};
#endif
...
"Def","AddrOps","AddrOp","BlendOps","BlendOp","Newlines", NULL
};
#endif
...
static const short yyr2[] = {     0,
     5,     6,     4,     5,     4,     5,     3,     4,     1,     2,
    11,     1,     2,     3,     5,     7,     1,     2,     5,     7,
     9,     1,     2
};

static const short yydefact[] = {     0,
     0,    22,     0,     0,     0,    23,     0,     0,     0,     0,
     9,     0,    12,     7,    17,     0,     0,     0,     0,    10,
     0,     5,    13,     3,    18,     0,     0,     8,     0,     0,
    14,     0,     1,     0,     6,     4,     0,     0,     0,     2,
     0,     0,    15,     0,    19,     0,     0,     0,     0,    16,
     0,    20,     0,     0,     0,    21,     0,    11,     0,     0,
     0
};
...
static const short yypact[] = {    41,
     1,-32768,    57,    50,     1,-32768,     0,    10,    20,    42,
-32768,    -6,-32768,    22,-32768,    50,    -3,    29,    45,-32768,
    -6,    22,-32768,    22,-32768,    42,    -6,    22,    47,    56,
    59,    58,    22,    -6,    22,    22,    55,    30,    31,    22,
    61,    62,    59,    63,    59,    60,     1,    38,    66,    59,
    67,    59,    64,     1,    70,    59,     1,    59,    72,    76,
-32768
};
...
static const short yytable[] = {     4,
    25,     8,     9,    16,     2,    17,    29,    22,    25,    24,
    25,    21,    20,    28,    25,    18,    31,    27,    33,    25,
    23,    25,    25,    35,    36,    19,    25,    34,    20,    23,
     9,    40,     2,     2,     2,    23,    43,    45,    30,    42,
    44,     2,    23,     1,     2,    50,    52,    51,     7,     8,
     9,    37,    56,     6,    32,    58,     7,     8,     9,     5,
     6,    38,     6,    39,    41,    46,    26,    47,    48,    49,
    53,    60,    54,    55,    57,    61
};

static const short yycheck[] = {     1,
    14,     8,     9,     5,     4,     6,    10,    10,    22,    12,
    24,    10,    10,    16,    28,     6,    18,    16,    21,    33,
    12,    35,    36,    26,    27,     6,    40,    26,    26,    21,
     9,    34,     4,     4,     4,    27,    38,    39,    10,    10,
    10,     4,    34,     3,     4,    47,    48,    10,     7,     8,
     9,     5,    54,     4,    10,    57,     7,     8,     9,     3,
     4,     6,     4,     6,    10,     5,    16,     6,     6,    10,
     5,     0,     6,    10,     5,     0
};
  ...
  *++yyssp = yystate;
  ...
  if (yyssp >= yyss + yystacksize - 1)
    ...
    yystacksize = YYMAXDEPTH;
      ...
      __yy_memcpy ((char *)yyss, (char *)yyss1, (unsigned int)(size * sizeof (*yyssp)));
      yyvs = (YYSTYPE *) YYSTACK_ALLOC (yystacksize * sizeof (*yyvsp));
      __yy_memcpy ((char *)yyvs, (char *)yyvs1, (unsigned int)(size * sizeof (*yyvsp)));
#ifdef YYLSP_NEEDED
      yyls = (YYLTYPE *) YYSTACK_ALLOC (yystacksize * sizeof (*yylsp));
      __yy_memcpy ((char *)yyls, (char *)yyls1, (unsigned int)(size * sizeof (*yylsp)));
#endif
#endif /* no yyoverflow */
...
// #line 268 "ps1.0_grammar.y"
{
    ...
    break;}
case 22:
// #line 286 "ps1.0_grammar.y"
{;
    break;}
case 23:
// #line 290 "ps1.0_grammar.y"
{;
    break;}
}
