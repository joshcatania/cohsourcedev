...
#include "../include/libcubemapgen/Types.h"
#include "../include/libcubemapgen/ErrorMsg.h"

uint32 sg_MessageType = EM_DEFAULT_MESSAGE_MEDIUM;

//MessageOutputCallback
void (*sg_MessageOutputCallback)(WCHAR const*, WCHAR const*) = DefaultErrorMessageCallback; 
...
//
//--------------------------------------------------------------------------------------
void DefaultErrorMessageCallback(WCHAR const* a_Title, WCHAR const* a_Message )
{
...
//
//--------------------------------------------------------------------------------------
void SetErrorMessageCallback( void(*a_MessageOutputFunc)(WCHAR const*, WCHAR const*) )
{
...
//   this mechanism.
//--------------------------------------------------------------------------------------
void OutputMessageString(WCHAR const* a_Title, WCHAR const* a_Message )
{
...
//--------------------------------------------------------------------------------------
void OutputMessage(WCHAR const* a_Message, ... )
{   
...
//--------------------------------------------------------------------------------------
bool OutputQuestion( WCHAR const* a_Message, ... )
{
   WCHAR msgBuffer[ EM_MAX_MESSAGE_LENGTH ];
   va_list args;
   va_start( args, a_Message );
...
//  
//--------------------------------------------------------------------------------------
HRESULT OutputMessageOnFail(HRESULT a_hr, WCHAR const* a_Message, ... )
{   
    int32 numCharOutput = 0;
    WCHAR msgBuffer[EM_MAX_MESSAGE_LENGTH];
    va_list args;
...
//  
//--------------------------------------------------------------------------------------
HRESULT OutputFatalMessageOnFail(HRESULT a_hr, WCHAR const* a_Message, ... )
{   
    int32 numCharOutput = 0;
    WCHAR msgBuffer[EM_MAX_MESSAGE_LENGTH];
    va_list args;
