...
timeout 2
start /min arenaserver.exe -db 192.168.0.1
timeout 2
start /min raidserver.exe -db 192.168.0.1
timeout 2
start /min statserver.exe -db 192.168.0.1
timeout 2
start /min TurnstileServer.exe
timeout 2
start /min QueueServer.exe -db 192.168.0.1
timeout 2
