...
#include "entity/TokenizerUiWidget.h"
...
typedef enum DetailRecipeFlags
{
    ...
    RECIPE_INVENTION_LIC_REQUIRED    =   (1 << 5),    // This detail recipe requires an invention license to create
    RECIPE_NO_REFUND                =   (1 << 6),    // This detail recipe when used as a voucher cannot be refunded
    RECIPE_FIXED_LEVEL                =   (1 << 7),    // This detail recipe awards a fixed level recipe or enhancement,
                                                    //   though it appears to have a level range in split pane UIs
    RECIPE_FORCE_CLAIM_DELAY        =    (1 << 8),    // Claiming this recipe via the account / character items
...
typedef struct DetailRecipe
{
    ...
    const char **pchAdditionalComponents;
        // additional stuff required to make this recipe
